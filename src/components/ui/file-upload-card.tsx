...
export function FileUploadCard({ onChange, initalPreviewUrl }: { onChange: (file: File | null) => void, initalPreviewUrl?: string }) {
  const maxSizeMB = 5
  ...
  const previewUrl = files[0]?.preview || initalPreviewUrl || null
